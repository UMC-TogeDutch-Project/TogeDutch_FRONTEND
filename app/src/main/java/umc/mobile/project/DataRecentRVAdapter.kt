...
//            if(id != null) {
//                Log.d("체크된 post 제목 ======================== ", homeDataList[position].title)
...
//    private var contentPostId = 0
//
//    private val clickedLikeStatus = arrayListOf<Like>()
//
//    private lateinit var likes : Like
//
//    private var itemPosition : Int = 0
...
//        LikePostGetResult {
//
//        fun bind(homeData: Post, clickStatus: Like) {
//
//            Glide.with(context).load(homeData.image).centerCrop().into(viewBinding.ivItemImageThird)
//
//            viewBinding.tvItemTitle.text = homeData.title //제목
...
//            likes = clickStatus
//
//            viewBinding.btnLikeThird.isSelected = clickStatus.isSelected
//
...
//                    likes.isSelected = viewBinding.btnLikeThird.isSelected
//
//                    clickedLikeStatus.add(Like(itemPosition, true))
//
