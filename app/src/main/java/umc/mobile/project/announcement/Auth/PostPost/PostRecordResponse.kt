...
data class Result(
    ...
    @SerializedName(value =  "order_time") val order_time : Instant,
    ...
    @SerializedName(value =  "created_at") val created_at : Instant,
    @SerializedName(value =  "updated_at") val updated_at : Instant,
